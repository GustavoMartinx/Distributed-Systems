...
* Esse grpc para implementar a comunicação entre o client e o server
* 
*/
...
public class MovieClient {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Cria uma instância de MovieClient com o IP e a porta fornecidos
        ...
        while (true) {
            ...
            // Verifica se a entrada pode ser convertida para um inteiro
            if (isConvertibleToInt(readed)) {
                choise = Integer.parseInt(readed);
                // Se a escolha for 7, encerra o programa
                if (choise == 7) {
